...
public class Student {
    ...
    public String toString() {
        ...
        return("First name: "+firstName+"Last name:  "+lastName+"the ID: "+id+"Average grade:  "+averageGrade);
    }
    ...
    public boolean equals(Object o) {
        ...
        if(this.id != c.id || !this.averageGrade.equals(c.averageGrade) || !this.lastName.equals(c.lastName) || !this.firstName.equals(c.firstName)){
            return false;
        }
    ...
    public int hashCode() {
        int b=28935234;
        b=b*31*this.firstName.hashCode();
        b=b*31*this.lastName.hashCode();
        b=b*31*this.averageGrade.hashCode();
